...
d3.chart.brush = function() {
  ...
  function chart(container) {
    ...
    rects.attr({
      x: function(d) { return scale(d.postdate);},
      y: 0,
      width: 1,
      height: height
    ...
    brush.on("brushend", function() {
      ...
      var filtered = data.filter(function(d) {
        return (d.postdate > ext[0] && d.postdate < ext[1])
      })
      g.selectAll("rect.events")
      .style("stroke", "")
      
      g.selectAll("rect.events")
      .data(filtered, function(d) { return d.postid })
      .style({
        stroke: "#fff"
      })
  ...
  chart.highlight = function(data) {
    ...
    rects.data(data, function(d) { return d.postid })
    .style("stroke", "orange")
